...
Rectangle {
  ...
  Text { anchors.centerIn: parent; text: "power_settings_new"; color: buttonHover.hovered ? Appearance.m3colors.m3onErrorContainer : Appearance.m3colors.m3onSurface; font.family: Appearance.font.family.iconMaterial; font.pixelSize: 13 }
