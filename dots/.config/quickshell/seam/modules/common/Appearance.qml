...
Singleton {
    id: root
    // Seam compatibility API. The imported end-4 modules continue to use the
    // richer rounding object below, while Seam components use radius().
    ...
    property Settings seamAppearanceSettings: Settings {
        location: "file://" + Quickshell.env("HOME") + "/.local/state/quickshell/appearance.ini"
        category: "SeamAppearance"
