...
Item {
    ...
    property var allCommands: [
        {
            name: "login",
            description: Translation.tr("Sign in to Codex CLI with ChatGPT"),
            execute: args => {
                Quickshell.execDetached(["bash", "-c", `${Config.options.apps.terminal} codex login`]);
                Ai.addMessage(Translation.tr("Opened Codex CLI login in the terminal."), Ai.interfaceRole);
            }
        },
        {
            name: "attach",
